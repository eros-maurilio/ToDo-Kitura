...
public struct SimpleToDo : Codable, Equatable {
    public var title: String?
    public var author: String?
    public var pages: Int32?
    public var publisher: String?
    ...
    public static func ==(lhs: SimpleToDo, rhs: SimpleToDo) -> Bool {
        return (lhs.title == rhs.title) && (lhs.author == rhs.author) && (lhs.pages == rhs.pages) && (lhs.publisher == rhs.publisher) && (lhs.hasSequence == rhs.hasSequence) && (lhs.completed == rhs.completed) && (lhs.orderId == rhs.orderId)
    }
}
